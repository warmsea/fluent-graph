...
Complex.args = {
  graphProps: {
    ...
    links: [
      { source: "Mark 8", target: "Aerial", lineWeight: 2 },
      { source: "Mark 8", target: "GIS Mapping", isDashed: true },
      { source: "Mark 8", target: "Survey Intelligence", lineWeight: 2 },
      { source: "Mark 8", target: "Flight Operations", isDashed: true, lineWeight: 2 },
      { source: "Mark 8", target: "Coffee" },
      { source: "Mark 8", target: "Tea" },
      { source: "Mark 8", target: "Juice", lineColor: "red" },
      { source: "Aerial", target: "Structual Integrity", isDashed: true },
      ...
      { source: "Survey Intelligence", target: "Geothermal", isDashed: true },
      { source: "Flight Operations", target: "United" },
      { source: "Flight Operations", target: "Delta" },
      { source: "Structual Integrity", target: "Swiftly", isDashed: true },
      ...
      { source: "Juno", target: "Milk", isDashed: true },
    ],
    nodeConfig: {
      focusable: true,
    },
